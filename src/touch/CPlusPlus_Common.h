...
public:
	...
	{
		downloadType = OP_TOP_INPUT_DOWNLOAD_DELAYED;
		verticalFlip = false;
		cpuMemPixelType = BGRA8Fixed;
	}
	...
	CPUMemPixelType			cpuMemPixelType;
